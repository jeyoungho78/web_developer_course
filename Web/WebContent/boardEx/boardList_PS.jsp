...
<% Connection con = null;
   ...
   try {
		 ...
		 pstmt = con.prepareStatement(sql); // 쿼리를 실행하기 위한 객체생성 
        ...
        <tbody>
        	<%   // 선택 페이지의 컨텐츠 표시
	    		 ...
	    		 if (!field.equals("") || !searchWord.equals("")){
		    		 ...
		    		 pstmt.setInt(3, contentStart);
		    		 pstmt.setInt(4, contentEnd);
	    		 } else {
	    			 pstmt.setInt(2, contentStart);
		    		 pstmt.setInt(3, contentEnd);
	    		 }
