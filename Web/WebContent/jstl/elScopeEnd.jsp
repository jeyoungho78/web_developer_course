...
4.1 sessionObject Scope에 저장된 name1의 value(Vector)의 empty 유무 <br/>
	- ${ empty sessionScope.name1 } <br/>
	- ${ empty sessionScope["name1"] } <br/><br/>

4.2 sessionObject Scope에 저장된 name1의 value(Vector)의 0번째 index 접근 <br/>
	- ${ sessionScope.name1[0] } <br/>
	- ${ sessionScope["name1"][0] } <br/><br/>

5.1 applicationObject Scope에 저장된 name의 value(HashMap)의 empty 유무 <br/>
	- ${ empty applicationScope.name } <br/>
	- ${ empty applicationScope["name"] } <br/><br/>

5.2 applicationObject Scope에 저장된 name의 value(HashMap)의 내용 a의 value접근<br/>
	- ${ applicationScope.name.a } <br/>
	- ${ applicationScope["name"].a } <br/><hr/><hr/><br/>
	<!-- (String)((HashMap)application.getAttribute("name")).get("a"); -->
