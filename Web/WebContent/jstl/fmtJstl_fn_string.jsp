...
<body>
	...
	<c:out value="${'abcdefg,ABCDEFGH,우리나라,<>' }"/>
	<br>
	<br>
	...
	\${fn:indexOf('abcdefg,ABCDEFGH,우리나라,<>', 'c') } : ${fn:indexOf(temp, 'c') } <br>
	<br><br><br>
	...
	\${fn:replace('abcdefg,ABCDEFGH,우리나라,<>', 'ABCDEFGH',  '-----') } : ${fn:replace(temp, 'ABCDEFGH', '-----') } <br>
