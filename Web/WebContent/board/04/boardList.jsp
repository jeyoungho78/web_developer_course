...
<%@ taglib uri="/WEB-INF/tld/board.tld" prefix="bbs" %>
...
<div class="wrap">
    ...
    <div class="ui_page_navigator" role="navigation" aria-label="페이지 선택">
    	...
    	<bbs:boardTag type="PREV" pageNum="${underViewPageStart}" pageNumURL="${prePagingURL}"></bbs:boardTag>
    	<c:forEach var="map" items="${pagingList}">
    		...
    		<bbs:boardTag type="PAGE" pageNum="${pageNum}" pageNumURL="${pageNumURL}" selectedPage="${selectedPage}"></bbs:boardTag>
    	</c:forEach>
    	<bbs:boardTag type="NEXT" pageNum="${underViewPageEnd}" pageNumURL="${nextPagingURL}" totalPageCount = "${totalPageCount}"></bbs:boardTag>
